# 2026-07-06 Nginx, Docker, AWS 인프라 학습 로드맵
...
### 3순위: AWS VPC / Security Group / ALB - 왜 공부해야 하는가?
...
### 3순위: AWS VPC / Security Group / ALB - 공부할 내용
...
### 3순위: AWS VPC / Security Group / ALB - 핵심 개념
...
### 3순위: AWS VPC / Security Group / ALB - 정리 목표
